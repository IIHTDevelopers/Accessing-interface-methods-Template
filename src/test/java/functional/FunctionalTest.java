...
public class FunctionalTest {
	...
	String filePath = "src/main/java/com/yaksha/assignment/AccessingInterfaceMethodsAssignment.java";
	...
	public void testMethodOperationsOnly() throws Exception {
		...
		boolean result = autoGrader.testAccessingInterfaceMethods(filePath);
